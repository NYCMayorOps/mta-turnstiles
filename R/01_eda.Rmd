...
|DESc     | Represent the "REGULAR" scheduled audit event (Normally occurs every 4 hours)
           2. Additionally, there may be a "RECOVR AUD" entry: This refers to a missed audit that was 
           1. Audits may occur more that 4 hours due to planning, or troubleshooting activities. recovered. |
...
- Control area, unit, and subunit channel position combined create a unique turnstile ID (is not duplicated across stations)
...
# Station Entries during rushhour
